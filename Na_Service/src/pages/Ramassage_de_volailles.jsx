...
function Ramassage_de_volailles() {
  const [images, setImages] = useState([]);

  useEffect(() => {
    // جلب البيانات من API
    axios.get('https://na-service.onrender.com/ramassage-de-volailles') // تأكد من أن هذا هو عنوان API الصحيح
      .then(response => {
...
export default Ramassage_de_volailles;
