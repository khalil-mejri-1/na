...
function PrestationsAvicoles_admin() {
        ...
        <div className="services-container">
          {lastImage1 && (
            <ServiceCard
              ...
              link="/Ramassage_de_volailles_admin"
          ...
          {lastImage2 && (
            <ServiceCard
              ...
              description="Nos équipes expérimentées effectuent avec précision tous les travaux manuels nécessaires dans votre vignoble, de l'ébourgeonnage à l'effeuillage."
              link="/Vaccination_de_Volailles_admin"
          ...
          {lastImage3 && (
            <ServiceCard
              ...
              description="Nos équipes expérimentées effectuent avec précision tous les travaux manuels nécessaires dans votre vignoble, de l'ébourgeonnage à l'effeuillage."
              link="/nettoyage_et_desinfection_admin"
          ...
          {lastImage4 && (
            <ServiceCard
              ...
              description="Nos équipes expérimentées effectuent avec précision tous les travaux manuels nécessaires dans votre vignoble, de l'ébourgeonnage à l'effeuillage."
              link="/Dératisation_Désinsectisation_admin"
...
export default PrestationsAvicoles_admin;
